...
export function PageHeader({ eyebrow, title, intro, breadcrumb, aside, className }: PageHeaderProps) {
  return (
      ...
      <Container>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr] lg:items-end">
          <div className="flex flex-col gap-5">
            ...
            <h1 className="max-w-[18ch] text-5xl font-semibold tracking-[-0.025em]">{title}</h1>
            {intro ? (
        ...
        <div aria-hidden="true" className="rule-soft mt-10" />
      </Container>
    </header>
  );
}
